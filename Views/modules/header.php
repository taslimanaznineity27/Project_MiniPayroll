<header class="main-header">
  ...
  <a href="" class="logo">
    ...
    <span class="logo-mini">
      <img class="img-responsive" src="Views/img/template/payroll.png" style="padding: 10px" />
    </span>

    <!-- normal logo -->
    <span class="logo-lg">
      <img class="img-responsive" src="Views/img/template/big-payroll.png" style="padding: 10px 0" />
    </span>
  </a>
