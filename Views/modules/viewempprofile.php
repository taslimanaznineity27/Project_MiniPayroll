                ...
                <div class="row">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <button class="btn btn-danger btn-block btn-flat"> Incriment</button>
                            </div>
                            <div class="col-xs-3">
                                <button class="btn btn-info btn-block btn-flat"> Promotions</button>
                            </div>
                            <div class="col-xs-3">
                                <button class="btn btn-info btn-block btn-flat"> Back </button>
                            </div>
                        </div>
                        <?php
